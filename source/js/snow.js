...
function snowCanvas() {
  /* 添加Dom结点 */
  var bannerContainers = $("#bannerContainer");
  if (!bannerContainers || !bannerContainers.length) return;
  var bannerContainer = bannerContainers[0];
  ...
  bannerContainer.appendChild(snowcanvas);
